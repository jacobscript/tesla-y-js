...
const wheelButtonsSelection = document.querySelector('#wheel-buttons')
...
// Handle Sccessory Checkbox Listeners
accessoryCheckboxes.forEach((checkbox) => {
...
wheelButtonsSelection.addEventListener('click', handleWheelButtonClick)
